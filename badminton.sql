...
CREATE TABLE `area`  (
  ...
  `good_num` int(3) NULL DEFAULT NULL,
  `bad_num` int(3) NULL DEFAULT NULL,
  `good_rate` int(3) NULL DEFAULT NULL,
...
CREATE TABLE `user`  (
  ...
  `user_pic` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
